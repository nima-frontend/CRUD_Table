...
if (localStorage.getItem('userProfile')) {
  originalData = JSON.parse(localStorage.getItem('userProfile'))
} else if (window.sampleUsers) {
  originalData = window.sampleUsers
...
uploadimg.onchange = function(){
    if(uploadimg.files[0].size < 2000000){   // 2MB 
    ...
    if(getData.length > 0){
        for(let i=tab_start; i<tab_end; i++){
            ...
            if(staff){
                ...
                <td>
                    <button onclick="readInfo('${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.cityVal}', '${staff.positionVal}', '${staff.salaryVal}', '${staff.sDateVal}', '${staff.emailVal}')"><i class="fa-regular fa-eye"></i></button>

                    <button onclick="editInfo('${i}', '${staff.picture}', '${staff.fName}', '${staff.lName}', '${staff.ageVal}', '${staff.cityVal}', '${staff.positionVal}', '${staff.salaryVal}', '${staff.sDateVal}', '${staff.emailVal}')"><i class="fa-regular fa-pen-to-square"></i></button>
...
function readInfo(pic, fname, lname, Age, City, Position, Salary, SDate, Email){
    imgInput.src = pic
    fName.value = fname
    lName.value = lname
    age.value = Age
...
function editInfo(id, pic, fname, lname, Age, City, Position, Salary, SDate, Email){
    isEdit = true
    editId = id
...
form.addEventListener('submit', (e)=> {
    ...
    const information = {
        id: Date.now(),
        picture: imgInput.src == undefined ? "./img/avatar.jpg" :imgInput.src,
        fName: fName.value,
        lName: lName.value,
        ageVal: age.value,
        cityVal: city.value,
